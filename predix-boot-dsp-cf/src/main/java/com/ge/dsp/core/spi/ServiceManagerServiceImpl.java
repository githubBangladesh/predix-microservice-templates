...
/**
 * An implementation of ONE of the Dsp ServiceManager interface methods that works to
 * allow for Karaf based RestServices to be deployed to the cloud.
 * 
 * see predix-boot-cf/Application.java for more info
 * 
 * If you need to implement others please go ahead and add that logic.
 * 
 * @author predix
 */
@Component
...
public class ServiceManagerServiceImpl implements IServiceManagerService{
	...
	public void setupServer(Object service, Map<String, String> attributeMap) {
		...
		if (attributeMap != null )
			providerType = attributeMap.get(NamedCxfProperties.DSP_CUSTOM_CXF_PROVIDERS);
